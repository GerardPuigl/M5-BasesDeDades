...
CREATE TABLE `authors` (
  ...
  KEY `fk_Authors_Addresses1_idx` (`Addresses_address_id`),
  CONSTRAINT `fk_Authors_Addresses1` FOREIGN KEY (`Addresses_address_id`) REFERENCES `addresses` (`address_id`)
...
INSERT INTO `authors` VALUES (1,'Autor1','Apellido1',1),(2,'Autor2','Apellido2',2),(3,'Autor3','Apellido3',3);
