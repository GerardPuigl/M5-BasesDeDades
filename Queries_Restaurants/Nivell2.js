...
db.Restaurants.find({ $and: [{ borough: { $not: /Staten Island/ } }, { borough: { $not: /Queens/ } }, { borough: { $not: /Bronx/ } }, { borough: { $not: /Brooklyn/ } }] },
    { restaurant_id: true, name: true, borough: true, cuisine: true }).pretty()
...
db.Restaurants.find({ $or: [{ cuisine: "Seafood" }, { name: /Wil/ }] },
    { restaurant_id: true, name: true, borough: true, cuisine: true }).pretty()
//nota: No acabo d'entendre on cal filtrar això del peix.
